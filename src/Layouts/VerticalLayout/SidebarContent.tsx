        ...
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/stock" >Estoque de Chapas</Link>
                </li>
                <li>
                  <Link to="/producao" >Produção de Chapas</Link>
                </li>
                <li>
                  <Link to="/estoque-by-material-classificacao" >Estoque por Material e Classificação</Link>
                </li>
                <li>
                  <Link to="/estoque-by-material-classificacao" >Estoque por Material e Classificação</Link>
                </li>
                <li>
                  <Link to="/vendas-by-vendedor" >Relatório de vendas por vendedor</Link>
                </li>
                <li>
                  <Link to="/meta" >Metas</Link>
                </li>
                <li>
                  <Link to="/vendas-por-classificacao" >Vendas por Classificação</Link>
                </li>
              </ul>
            </li>
